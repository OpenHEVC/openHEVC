...
EPEL_FUNC(ff_hevc_put_epel3_h_l_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_h_r_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_v_u_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_v_d_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_hv_lu_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_hv_ld_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_hv_ru_neon_8)
EPEL_FUNC(ff_hevc_put_epel3_hv_rd_neon_8)
...
static void (*ff_hevc_put_uw_pixels_neon_green_8_fcts[])
		(uint8_t *dst, ptrdiff_t dststride,
		 uint8_t *src, ptrdiff_t srcstride,
         int height, intptr_t mx, intptr_t my, int width) = {
    0, //ff_hevc_put_qpel_uw_pixels_w4_neon_8,
	ff_hevc_put_qpel_uw_pixels_w4_neon_8,
	0, //ff_hevc_put_qpel_uw_pixels_w6_neon_8,
...
void ff_hevc_put_qpel1_neon_wrapper1(uint8_t *dst, ptrdiff_t dststride, uint8_t *src, ptrdiff_t srcstride,
	...
	ff_hevc_put_pixels_neon_green_8_fcts[idx](dst, dststride, src + offset, srcstride, height, mx, my, width);
}
...
static void (*ff_hevc_put_epel3_h_neon_fcts[])
			   (int16_t *dst, ptrdiff_t dststride,
				uint8_t *src, ptrdiff_t srcstride,
				int height, intptr_t mx, intptr_t my, int width) = {
		ff_hevc_put_epel3_h_l_neon_8,
		ff_hevc_put_epel3_h_r_neon_8
};
void ff_hevc_put_epel3_h_neon_wrapper(
		int16_t *dst, ptrdiff_t dststride,
		uint8_t *src, ptrdiff_t srcstride,
        int height, intptr_t mx, intptr_t my, int width) {
    int offset = (mx-1) >> 2;
    ff_hevc_put_epel3_h_neon_fcts[offset](dst, dststride, src, srcstride, height, mx, my, width);
}

static void (*ff_hevc_put_epel3_v_neon_fcts[])
			   (int16_t *dst, ptrdiff_t dststride,
				uint8_t *src, ptrdiff_t srcstride,
				int height, intptr_t mx, intptr_t my, int width) = {
		ff_hevc_put_epel3_v_u_neon_8,
		ff_hevc_put_epel3_v_d_neon_8
};
void ff_hevc_put_epel3_v_neon_wrapper(
		int16_t *dst, ptrdiff_t dststride,
		uint8_t *src, ptrdiff_t srcstride,
        int height, intptr_t mx, intptr_t my, int width) {
    int offset = (my-1) >> 2;
    ff_hevc_put_epel3_v_neon_fcts[offset](dst, dststride, src, srcstride, height, mx, my, width);
}

static  void (*ff_hevc_put_epel3_hv_neon_fcts[])
			   (int16_t *dst, ptrdiff_t dststride,
			    uint8_t *_src, ptrdiff_t _srcstride,
			    int height, intptr_t mx, intptr_t my, int width) = {
		ff_hevc_put_epel3_hv_lu_neon_8,
		ff_hevc_put_epel3_hv_ru_neon_8,
		ff_hevc_put_epel3_hv_ld_neon_8,
		ff_hevc_put_epel3_hv_rd_neon_8
};
void ff_hevc_put_epel3_hv_neon_wrapper(
		int16_t *dst, ptrdiff_t dststride,
		uint8_t *src, ptrdiff_t srcstride,
        int height, intptr_t mx, intptr_t my, int width) {
	int offset = ((mx-1)&0x4)>>2 | ((my-1)&0x4)>>1;
	ff_hevc_put_epel3_hv_neon_fcts[offset](dst, dststride, src, srcstride, height, mx, my, width);
}
...
av_cold void green_reload_filter_chroma3(chroma_config *c, const int bit_depth)
{
    if (bit_depth == 8) {
        ...
        for (x = 0; x < 10; x++) {
            c->put_hevc_epel[x][0][0]         = ff_hevc_put_pixels_neon_green_8_fcts[x];
            c->put_hevc_epel[x][1][0]         = ff_hevc_put_epel3_v_neon_wrapper;
            c->put_hevc_epel[x][0][1]         = ff_hevc_put_epel3_h_neon_wrapper;
            c->put_hevc_epel[x][1][1]         = ff_hevc_put_epel3_hv_neon_wrapper;
        }
    }
}
