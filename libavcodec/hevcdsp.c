...
DECLARE_ALIGNED(16, const int8_t, ff_hevc_qpel_filters[3][16]) = {
...
#if GREEN_FILTER_TYPE == OLD
	{ -1,  4,-10, 58, 17, -5,  1,  0, -1,  4,-10, 58, 17, -5,  1,  0},
	{ -1,  4,-11, 40, 40,-11,  3,  0, -1,  4,-11, 40, 40,-11,  3,  0},
	{  0,  1, -5, 17, 58,-10,  4, -1,  0,  1, -5, 17, 58,-10,  4, -1}
#elif GREEN_FILTER_TYPE == SYMMETRIC
	{ -1,  4,-10, 58, 17, -5,  1,  0, -1,  4,-10, 58, 17, -5,  1,  0},
	{ -1,  4,-11, 40, 40,-11,  3,  0, -1,  4,-11, 40, 40,-11,  3,  0},
	...
	{ -1,  4,-10, 58, 17, -5,  1,  0, -1,  4,-10, 58, 17, -5,  1,  0},
	{ -1,  4,-11, 40, 40,-11,  3,  0, -1,  4,-11, 40, 40,-11,  3,  0},
	{ -1,  3, -7, 19, 56, -8,  2,  0, -1,  3, -7, 19, 56, -8,  2,  0}
#endif
#elif LUMA_TAPS == 5
#if GREEN_FILTER_TYPE == OLD
	{  0,  1, -8, 58, 16, -3,  0,  0,  0,  1, -8, 58, 16, -3,  0,  0 },
	{  0,  2, -9, 40, 40, -9,  0,  0,  0,  2, -9, 40, 40, -9,  0,  0 },
	{  0,  1, -4, 17, 54, -4,  0,  0,  0,  1, -4, 17, 54, -4,  0,  0 }
#elif GREEN_FILTER_TYPE == SYMMETRIC
    {  0,  1, -9, 58, 17, -3,  0,  0,  0,  1, -9, 58, 17, -3,  0,  0 },
    {  0,  2,-10, 41, 37, -6,  0,  0,  0,  2,-10, 41, 37, -6,  0,  0 },
    {  0,  0, -3, 17, 58, -9,  1,  0,  0,  0, -3, 17, 58, -9,  1,  0 }
#elif GREEN_FILTER_TYPE == ASYMMETRIC
    {  0,  1, -9, 58, 17, -3,  0,  0,  0,  1, -9, 58, 17, -3,  0,  0 },
    {  0,  2,-10, 41, 37, -6,  0,  0,  0,  2,-10, 41, 37, -6,  0,  0 },
    {  0,  1, -6, 19, 55, -5,  0,  0,  0,  1, -6, 19, 55, -5,  0,  0 }
#endif
#elif LUMA_TAPS == 3
#if GREEN_FILTER_TYPE == OLD
	{  0,  0, -8, 58, 14,  0,  0,  0,  0,  0, -8, 58, 14,  0,  0,  0 },
	{  0,  0, -8, 40, 32,  0,  0,  0,  0,  0, -8, 40, 32,  0,  0,  0 },
	{  0,  0, -4, 20, 48,  0,  0,  0,  0,  0, -4, 20, 48,  0,  0,  0 }
#elif GREEN_FILTER_TYPE == SYMMETRIC
    {  0,  0, -6, 58, 12,  0,  0,  0,  0,  0, -6, 58, 12,  0,  0,  0 },
    {  0,  0, -7, 42, 29,  0,  0,  0,  0,  0, -7, 42, 29,  0,  0,  0 },
    {  0,  0,  0, 12, 58, -6,  0,  0,  0,  0,  0, 12, 58, -6,  0,  0 }
#elif GREEN_FILTER_TYPE == ASYMMETRIC
    {  0,  0, -6, 58, 12,  0,  0,  0,  0,  0, -6, 58, 12,  0,  0,  0 },
    {  0,  0, -7, 42, 29,  0,  0,  0,  0,  0, -7, 42, 29,  0,  0,  0 },
    {  0,  0, -4, 21, 47,  0,  0,  0,  0,  0, -4, 21, 47,  0,  0,  0 }
#endif
#elif LUMA_TAPS == 1
...
#define HEVC_DSP_UP(depth)                                                             \
    ...
    printf("Luma %d Chroma %d\n", LUMA_TAPS, CHROMA_TAPS);
}

#if CONFIG_GREEN
#include "hevcdsp_green.c"
#endif
