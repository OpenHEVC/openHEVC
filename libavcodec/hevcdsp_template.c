...
//#define SSE_weight_pred_luma no test video available
//#define SSE_weight_pred_chroma no test video available
...
_mm_loadu_si128((__m128i*)&tmp[x-3*srcstride])
#define QPEL2_X3V_FILTER_1                                              \
_mm_loadu_si128((__m128i*)&tmp[x-3*srcstride])
#define QPEL2_X4V_FILTER_3                                              \
_mm_loadu_si128((__m128i*)&tmp[x+4*srcstride])
                                      ...
                                      int width, int height)
{
    ...
    for (y = 0; y < height; y++) {
        for (x = 0; x < width; x+=16) {
            r0= _mm_loadu_si128(&src[x]);

            r1= _mm_loadu_si128(&src[x+8]);
                                        ...
                                        int width, int height)
{
    ...
    for (y = 0; y < height; y++) {
            ...
            for (x = 0; x < width; x+=16) {
            r0= _mm_loadu_si128(&src1[x]);
            r1= _mm_loadu_si128(&src1[x+8]);
            r2=_mm_loadu_si128(&src2[x]);
            r3= _mm_loadu_si128(&src2[x+8]);
