        ...
        if (EXTERNAL_MMX(mm_flags)) {
            ...
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSSE3(mm_flags)) {
                    ...
                    PEL_LINK_SSE(c->put_hevc_qpel, 0, 0, 0, pel_pixels4 ,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 1, 0, 0, pel_pixels8 ,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 2, 0, 0, pel_pixels16,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 3, 0, 0, pel_pixels16,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 4, 0, 0, pel_pixels16,  8);
                    ...
                    c->put_hevc_qpel_v_14[0] = ff_hevc_put_hevc_qpel_v4_14_sse;
                    c->put_hevc_qpel_v_14[1] = ff_hevc_put_hevc_qpel_v8_14_sse;
                    c->put_hevc_qpel_v_14[2] = ff_hevc_put_hevc_qpel_v8_14_sse;
                    c->put_hevc_qpel_v_14[3] = ff_hevc_put_hevc_qpel_v8_14_sse;
                    c->put_hevc_qpel_v_14[4] = ff_hevc_put_hevc_qpel_v8_14_sse;
                ...
                if (EXTERNAL_SSE4(mm_flags)) {
                    ...
                    PEL_LINK_SSE(c->put_hevc_epel, 0, 0, 0, pel_pixels2 , 8);
                    PEL_LINK_SSE(c->put_hevc_epel, 1, 0, 0, pel_pixels4 , 8);
                    ...
                    PEL_LINK_SSE(c->put_hevc_epel, 0, 0, 1, epel_h2 , 8);
                    PEL_LINK_SSE(c->put_hevc_epel, 1, 0, 1, epel_h4 , 8);
                    PEL_LINK_SSE(c->put_hevc_epel, 2, 0, 1, epel_h8 , 8);
                    PEL_LINK_SSE(c->put_hevc_epel, 3, 0, 1, epel_h8 , 8);
                    PEL_LINK_SSE(c->put_hevc_epel, 4, 0, 1, epel_h8 , 8);
...
#endif
                    PEL_LINK_SSE(c->put_hevc_epel, 0, 0, 0, pel_pixels2 ,10);
                    PEL_LINK_SSE(c->put_hevc_epel, 1, 0, 0, pel_pixels4 ,10);
                    PEL_LINK_SSE(c->put_hevc_epel, 2, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_epel, 3, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_epel, 4, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_epel, 0, 0, 1, epel_h2, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 1, 0, 1, epel_h4, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 2, 0, 1, epel_h8, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 3, 0, 1, epel_h8, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 4, 0, 1, epel_h8, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 0, 1, 0, epel_v2, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 1, 1, 0, epel_v4, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 2, 1, 0, epel_v8, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 3, 1, 0, epel_v8, 10);
                    PEL_LINK_SSE(c->put_hevc_epel, 4, 1, 0, epel_v8, 10);

                    PEL_LINK_SSE(c->put_hevc_qpel, 0, 0, 0, pel_pixels4 ,10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 1, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 2, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 3, 0, 0, pel_pixels8 ,10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 4, 0, 0, pel_pixels8 ,10);
#if 1
