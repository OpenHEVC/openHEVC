...
void ff_upsample_filter_block_luma_h_8_8_sse( int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, int x_EL, int x_BL, int block_w, int block_h, int widthEL, const int16_t enabled_up_sample_filter_luma[16][8], struct HEVCWindow *Enhscal, struct UpsamplInf *up_info);
void ff_upsample_filter_block_cr_h_8_8_sse( int16_t *dst, ptrdiff_t dststride, uint8_t *_src, ptrdiff_t _srcstride, int x_EL, int x_BL, int block_w, int block_h, int widthEL, const int8_t enabled_up_sample_filter_chroma[16][4], struct HEVCWindow *Enhscal, struct UpsamplInf *up_info);
void ff_upsample_filter_block_cr_v_8_8_sse(uint8_t *dst, ptrdiff_t dststride, int16_t *_src, ptrdiff_t _srcstride, int x_EL, int y_EL, int block_w, int block_h, int widthEL, int heightEL, const int8_t enabled_up_sample_filter_chroma[16][4], struct HEVCWindow *Enhscal, struct UpsamplInf *up_info);
void ff_upsample_filter_block_luma_v_8_8_sse(uint8_t *dst, ptrdiff_t dststride, int16_t *_src, ptrdiff_t _srcstride, int x_EL, int y_EL, int block_w, int block_h, int widthEL, int heightEL, const int8_t enabled_up_sample_filter_luma[16][8], struct HEVCWindow *Enhscal, struct UpsamplInf *up_info);
...
/*
            ...
            //      c->upsample_filter_block_luma_h  = ff_upsample_filter_block_luma_h_8_sse;
            //      c->upsample_filter_block_cr_h    =   ff_upsample_filter_block_cr_h_8_sse;
               //   c->upsample_filter_block_cr_v    =   ff_upsample_filter_block_cr_v_8_sse;
                //  c->upsample_filter_block_luma_v  =   ff_upsample_filter_block_luma_v_8_sse;
*/
                    c->upsample_base_layer_frame = ff_upsample_base_layer_frame_sse;
                    c->upsample_h_base_layer_frame = ff_upsample_base_layer_frame_sse_h;
                    c->upsample_v_base_layer_frame = ff_upsample_base_layer_frame_sse_v;
