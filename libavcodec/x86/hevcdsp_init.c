        ...
        if (EXTERNAL_MMX(mm_flags)) {
            if (EXTERNAL_MMXEXT(mm_flags)) {
               ...
               //     c->put_hevc_qpel[0][1][0]= ff_hevc_put_hevc_qpel_v4_1_10_sse;
                    ...
                    PEL_LINK_SSE(c->put_hevc_qpel, 0, 0, 1, qpel_h2  , 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 1, 0, 1, qpel_h2  , 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 2, 0, 1, qpel_h2  , 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 3, 0, 1, qpel_h2  , 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 4, 0, 1, qpel_h2  , 10);
#endif
