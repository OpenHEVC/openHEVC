    ...
    __m128i t1, t2, t3, t4, t5, t6, t7, t8;
{
        ...
        for (y = 0; y < height; y ++) {
            for(x=0;x<width;x+=4){
                ...
                r0 = _mm_add_epi32(r0, _mm_mullo_epi32(x7,t7));
                r0= _mm_srli_epi32(r0,2); //bit depth - 8
...
void ff_hevc_put_hevc_qpel_v_2_10_sse(int16_t *dst, ptrdiff_t dststride,
    ...
    int x, y;
    uint16_t *src = (uint16_t*) _src;
    ptrdiff_t srcstride = _srcstride / sizeof(uint16_t);
    __m128i x1, x2, x3, x4, x5, x6, x7, x8, r0, r1, r2;
    __m128i t1, t2, t3, t4, t5, t6, t7, t8;
    r1 = _mm_set_epi16(-1, 4, -11, 40, 40, -11, 4, -1);
...

    {
        ...
        for (y = 0; y < height; y ++) {
            for(x=0;x<width;x+=4){
                ...
                r1= _mm_srli_epi32(r1,2); //bit depth - 8
