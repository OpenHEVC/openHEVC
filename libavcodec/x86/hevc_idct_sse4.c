        ...
        for(i=0; i < 16; i+=8) {
            ...
            if(!j){
                ...
                for ( k = 0; k < 8; k++) {
                    ...
                    dst[7] = av_clip_uint8(dst[7]+av_clip_int16(src[m+104]));


                    dst[8] = av_clip_uint8(dst[8]+av_clip_int16(src[m+128]));
                    dst[9] = av_clip_uint8(dst[9]+av_clip_int16(src[m+136]));
                    dst[10] = av_clip_uint8(dst[10]+av_clip_int16(src[m+160]));
                    dst[11] = av_clip_uint8(dst[11]+av_clip_int16(src[m+168]));
                    dst[12] = av_clip_uint8(dst[12]+av_clip_int16(src[m+192]));
                    dst[13] = av_clip_uint8(dst[13]+av_clip_int16(src[m+200]));
                    dst[14] = av_clip_uint8(dst[14]+av_clip_int16(src[m+224]));
                    dst[15] = av_clip_uint8(dst[15]+av_clip_int16(src[m+232]));
                    m +=1;
                    dst += stride;
                }
                if(!i){
        ...
        for(i=0; i < 32; i+=8) {
            ...
            if(!j){
                ...
                for ( k = 0; k < 8; k++) {
                    ...
                    dst[4] = av_clip_uint8(dst[4]+av_clip_int16(src[m+128]));
                    dst[5] = av_clip_uint8(dst[5]+av_clip_int16(src[m+128+8]));
                    dst[6] = av_clip_uint8(dst[6]+av_clip_int16(src[m+128+16]));
                    dst[7] = av_clip_uint8(dst[7]+av_clip_int16(src[m+128+24]));

                    dst[8] = av_clip_uint8(dst[8]+av_clip_int16(src[m+256]));
                    dst[9] = av_clip_uint8(dst[9]+av_clip_int16(src[m+256+8]));
                    dst[10] = av_clip_uint8(dst[10]+av_clip_int16(src[m+256+16]));
                    dst[11] = av_clip_uint8(dst[11]+av_clip_int16(src[m+256+24]));
                    dst[12] = av_clip_uint8(dst[12]+av_clip_int16(src[m+384]));
                    dst[13] = av_clip_uint8(dst[13]+av_clip_int16(src[m+384+8]));
                    dst[14] = av_clip_uint8(dst[14]+av_clip_int16(src[m+384+16]));
                    dst[15] = av_clip_uint8(dst[15]+av_clip_int16(src[m+384+24]));

                    dst[16] = av_clip_uint8(dst[16]+av_clip_int16(src[m+512]));
                    dst[17] = av_clip_uint8(dst[17]+av_clip_int16(src[m+512+8]));
                    dst[18] = av_clip_uint8(dst[18]+av_clip_int16(src[m+512+16]));
                    dst[19] = av_clip_uint8(dst[19]+av_clip_int16(src[m+512+24]));
                    dst[20] = av_clip_uint8(dst[20]+av_clip_int16(src[m+640]));
                    dst[21] = av_clip_uint8(dst[21]+av_clip_int16(src[m+640+8]));
                    dst[22] = av_clip_uint8(dst[22]+av_clip_int16(src[m+640+16]));
                    dst[23] = av_clip_uint8(dst[23]+av_clip_int16(src[m+640+24]));

                    dst[24] = av_clip_uint8(dst[24]+av_clip_int16(src[m+768]));
                    dst[25] = av_clip_uint8(dst[25]+av_clip_int16(src[m+768+8]));
                    dst[26] = av_clip_uint8(dst[26]+av_clip_int16(src[m+768+16]));
                    dst[27] = av_clip_uint8(dst[27]+av_clip_int16(src[m+768+24]));
                    dst[28] = av_clip_uint8(dst[28]+av_clip_int16(src[m+896]));
                    dst[29] = av_clip_uint8(dst[29]+av_clip_int16(src[m+896+8]));
                    dst[30] = av_clip_uint8(dst[30]+av_clip_int16(src[m+896+16]));
                    dst[31] = av_clip_uint8(dst[31]+av_clip_int16(src[m+896+24]));
