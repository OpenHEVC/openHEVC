...
void pred_angular_0_8_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_1_8_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_2_8_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_3_8_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
...
void pred_angular_0_10_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_1_10_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_2_10_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
void pred_angular_3_10_sse(uint8_t *_src, uint8_t *_top, uint8_t *_left, ptrdiff_t stride, int c_idx, int mode);
