...
////////////////////////////////////////////////////////////////////////////////
// ohhevc_transform_4x4_luma_X_sse2
////////////////////////////////////////////////////////////////////////////////
...
void ohhevc_transform_4x4_luma ## _ ## D ## _sse2(int16_t *_coeffs) {          \
    uint8_t  shift = 7;                                                        \
    int16_t *src    = _coeffs;                                                 \
...
////////////////////////////////////////////////////////////////////////////////
// ohhevc_transform_XxX_X_sse2
////////////////////////////////////////////////////////////////////////////////

#define TRANSFORM_4x4(D)                                                       \
void ohhevc_transform_4x4_ ## D ## _sse2 (int16_t *_coeffs, int col_limit) {  \
    int16_t *src    = _coeffs;                                                 \
    int16_t *coeffs = _coeffs;                                                 \
    int      shift  = 7;                                                       \
    int      add    = 1 << (shift - 1);                                        \
...
void ohhevc_transform_ ## H ## x ## H ## _ ## D ## _sse2 (                \
...
////////////////////////////////////////////////////////////////////////////////
// ohhevc_transform_XxX_DC_X_sse2
////////////////////////////////////////////////////////////////////////////////
...
void ohhevc_transform_ ## H ## x ## H ## _add_ ## D ## _sse2 (                \
