...
DECLARE_ALIGNED(16, static const int16_t, DCT_V_4x4_DC_H[16]) ={
194,  274,  274,  274, 194,  274,  274,  274, 194,  274,  274,  274, 194,  274,  274,  274
};

DECLARE_ALIGNED(16, static const int16_t, DCT_V_4x4_DC_V[16]) ={
194,  194,  194,  194, 274,  274,  274,  274, 274,  274,  274,  274, 274,  274,  274,  274
};

DECLARE_ALIGNED(16, static const int16_t, DCT_VIII_4x4_DC_H[16]) ={
336,  296,  219,  117 ,336,  296,  219,  117, 336,  296,  219,  117, 336,  296,  219,  117
};

DECLARE_ALIGNED(16, static const int16_t, DCT_VIII_4x4_DC_V[16]) ={
336, 336, 336, 336,  296, 296, 296, 296,  219, 219, 219, 219, 117, 117, 117, 117
};

DECLARE_ALIGNED(16, static const int16_t, DST_I_4x4_DC_H[16]) = {
190,  308,  308, 190, 190,  308,  308, 190, 190,  308,  308, 190, 190,  308,  308, 190,
};

DECLARE_ALIGNED(16, static const int16_t, DST_I_4x4_DC_V[16]) ={
190, 190, 190, 190,  308, 308, 308, 308,  308, 308, 308, 308, 190, 190, 190, 190,
};

DECLARE_ALIGNED(16, static const int16_t, DST_VII_4x4_DC_H[16]) ={
117,  219,  296,  336 ,117,  219,  296,  336 ,117,  219,  296,  336, 117,  219,  296,  336
};

DECLARE_ALIGNED(16, static const int16_t, DST_VII_4x4_DC_V[16]) ={
117, 117, 117, 117, 219, 219, 219, 219,  296, 296 , 296, 296,  336 , 336 , 336 , 336
};

/*8x8*/

DECLARE_ALIGNED(16, static const int16_t, DST_I_8x8_DC_H[16]) ={
117,  219,  296,  336,  336,  296,  219,  117 , 117,  219,  296,  336,  336,  296,  219,  117
};

DECLARE_ALIGNED(16, static const int16_t, DCT_V_8x8_DC_H[16]) ={
187,  264,  264,  264,  264,  264,  264,  264, 187,  264,  264,  264,  264,  264,  264,  264
};

DECLARE_ALIGNED(16, static const int16_t, DCT_VIII_8x8_DC_H[16]) ={
350,  338,  314,  280,  237,  185,  127,   65 , 350,  338,  314,  280,  237,  185,  127,   65
};

DECLARE_ALIGNED(16, static const int16_t, DST_VII_8x8_DC_H[16]) ={
65,  127,  185,  237,  280,  314,  338,  350 , 65,  127,  185,  237,  280,  314,  338,  350
};


/*16x16*/

DECLARE_ALIGNED(16, static const int16_t, DCT_V_16x16_DC[16]) ={
184,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,  260,
};

DECLARE_ALIGNED(16, static const int16_t, DCT_VIII_16x16_DC[16]) ={
356,  353,  346,  337,  324,  309,  290,  269,  246,  220,  193,  163,  133,  100,   67,   34 ,
};


DECLARE_ALIGNED(16, static const int16_t, DST_I_16x16_DC[16]) ={
65,  127,  185,  237,  280,  314,  338,  350,  350,  338,  314,  280,  237,  185,  127,   65 ,

};

DECLARE_ALIGNED(16, static const int16_t, DST_VII_16x16_DC[16]) ={
34,   67,  100,  133,  163,  193,  220,  246,  269,  290,  309,  324,  337,  346,  353,  356
};

/*32x32*/

DECLARE_ALIGNED(16, static const int16_t, DCT_V_32x32_DC[32]) ={
182,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258,  258
};

DECLARE_ALIGNED(16, static const int16_t, DCT_VIII_32x32_DC[32]) ={
359,  358,  357,  354,  351,  347,  342,  336,  329,  322,  314,  305,  296,  285,  275,  263,  251,  238,  225,  211,  197,  182,  167,  151,  135,  119,  103,   86,   69,   52,   35,   17
};

DECLARE_ALIGNED(16, static const int16_t, DST_I_32x32_DC[32]) ={
34,   67,  100,  133,  163,  193,  220,  246,  269,  290,  309,  324,  337,  346,  353,  356,  356,  353,  346,  337,  324,  309,  290,  269,  246,  220,  193,  163,  133,  100,   67,   34
};


DECLARE_ALIGNED(16, static const int16_t, DST_VII_32x32_DC[32]) ={
17,   35,   52,   69,   86,  103,  119,  135,  151,  167,  182,  197,  211,  225,  238,  251,  263,  275,  285,  296,  305,  314,  322,  329,  336,  342,  347,  351,  354,  357,  358,  359
};

#endif // HEVC_AMT_DEFS_H

static const int16_t const * const DTT_DC_summary_H[4][NUM_TRANS_TYPE] ={
    {NULL,   DST_I_4x4_DC_H,   DST_VII_4x4_DC_H,   DCT_VIII_4x4_DC_H,   DCT_V_4x4_DC_H},
    {NULL,   DST_I_8x8_DC_H,   DST_VII_8x8_DC_H,   DCT_VIII_8x8_DC_H,   DCT_V_8x8_DC_H},
    {NULL, DST_I_16x16_DC, DST_VII_16x16_DC, DCT_VIII_16x16_DC, DCT_V_16x16_DC},
    {NULL, DST_I_32x32_DC, DST_VII_32x32_DC, DCT_VIII_32x32_DC, DCT_V_32x32_DC},
};

static const int16_t const  * const DTT_DC_summary_V[4][NUM_TRANS_TYPE] = {
    {NULL,   DST_I_4x4_DC_V,   DST_VII_4x4_DC_V,   DCT_VIII_4x4_DC_V,   DCT_V_4x4_DC_V},
    {NULL,   DST_I_8x8_DC_H,   DST_VII_8x8_DC_H,   DCT_VIII_8x8_DC_H,   DCT_V_8x8_DC_H},
    {NULL, DST_I_16x16_DC, DST_VII_16x16_DC, DCT_VIII_16x16_DC, DCT_V_16x16_DC},
    {NULL, DST_I_32x32_DC, DST_VII_32x32_DC, DCT_VIII_32x32_DC, DCT_V_32x32_DC},
};
